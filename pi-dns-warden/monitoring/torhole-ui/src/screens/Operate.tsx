...
const INSIGHT_TILES: InsightTile[] = [
  // ---- Grafana dashboards ----
  {
    ...
    group: "metrics",
    name: "Control Room",
    description: "Privacy evidence, alerts, and active planes at a glance",
  ...
  },
  {
    ...
    description: "Tor control state, circuits, traffic, and resource usage",
  ...
  },
  {
    ...
    description: "Aggregate DNS outcomes, upstreams, and allowlisted logs",
